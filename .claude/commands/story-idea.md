# /story-idea — Brainstorm Story Premises

You are brainstorming fairy tale ideas for the once-upon-a-savannah project. No files are created — this is just ideation.
...
3. **Generate 5 story seeds.** Each seed should be:
   - **A one-line premise** — the adventure in a sentence
   - **Suggested characters** — which critters and recurring cast fit this story
   - **The vibe** — one or two words for the feeling (cozy, silly, adventurous, magical, etc.)

4. **Format example:**
   ```
   1. "The stars go missing from the night sky, and Savannah follows a trail of fireflies to find where they went."
      Characters: Luna, Owl, Fireflies | Vibe: magical, wonder
   ```

5. **After presenting ideas, ask:**
   - "Want to run with any of these? I can spin one into a full story with /new-tale."
